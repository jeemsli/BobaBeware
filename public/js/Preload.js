...
TopDownGame.Preload.prototype = {
  preload: function() { 
    ...
    this.load.tilemap('x1', '../maps/Floor 2/x1.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x2', '../maps/Floor 2/x2.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x3', '../maps/Floor 2/x3.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x4', '../maps/Floor 2/x4.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x5', '../maps/Floor 2/x5.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x6', '../maps/Floor 2/x6.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x7', '../maps/Floor 2/x7.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x8', '../maps/Floor 2/x8.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x9', '../maps/Floor 2/x9.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x10', '../maps/Floor 2/x10.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x11', '../maps/Floor 2/x11.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x12', '../maps/Floor 2/x12.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x13', '../maps/Floor 2/x13.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x14', '../maps/Floor 2/x14.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x15', '../maps/Floor 2/x15.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x16', '../maps/Floor 2/x16.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x17', '../maps/Floor 2/x17.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x18', '../maps/Floor 2/x18.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x19', '../maps/Floor 2/x19.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x20', '../maps/Floor 2/x20.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x21', '../maps/Floor 2/x21.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x22', '../maps/Floor 2/x22.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x23', '../maps/Floor 2/x23.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x24', '../maps/Floor 2/x24.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x25', '../maps/Floor 2/x25.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x26', '../maps/Floor 2/x26.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x27', '../maps/Floor 2/x27.json', null, Phaser.Tilemap.TILED_JSON);
    this.load.tilemap('x28', '../maps/Floor 2/x28.json', null, Phaser.Tilemap.TILED_JSON);
    ...
    this.game.load.audio('boba', 'assets/audio/Boba.wav');
